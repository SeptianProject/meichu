...
const CardCatalog = () => {
     ...
     return (
          <div onClick={() => navigate('/catalog-detail')}
               className='bg-[#302F35] p-2 rounded-2xl h-[17rem] xl:w-[24rem] 
               xl:h-[32rem] lg:p-5'>
               {/* Product name */}
               <div className='mt-2 flex items-center justify-between lg:mt-0'>
                    <h3 className='text-sm font-bold lg:text-xl'>Nama Product</h3>
                    <div className='border border-light rounded-full p-[5px] lg:p-2 w-fit'>
                         <FaHeart className='text-light size-3 lg:size-5' />
                    </div>
               </div>
               {/* Profile */}
               <div className='flex items-center gap-x-2 my-2'>
                    ...
                    <h4 className='text-xs font-medium lg:text-base'>@Meichu</h4>
               </div>
               {/* image content */}
               ...
               <div className='mt-5 flex items-center justify-start lg:justify-between gap-x-2'>
                    <div className='flex items-center gap-x-2'>
                         ...
                         <div className='flex flex-col'>
                              <h4 className='text-xs font-normal lg:text-base'>Credits</h4>
                              <h4 className='text-xs font-semibold lg:text-base'>4.3</h4>
                         </div>
                    </div>
                    <button className='border border-light text-light
