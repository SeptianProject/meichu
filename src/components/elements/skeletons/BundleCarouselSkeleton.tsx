                    ...
                    !max-w-[40rem] md:!max-w-[40rem] lg:!max-w-[50rem]">
                         <div className="rounded-3xl w-[23rem]">
                              <Skeleton className="rounded-3xl w-full h-[20rem] max-w-[65vw] 
                                        ...
                                        lg:h-[30rem] lg:max-w-[26rem] border border-graySurface2"/>
                         </div>
                         <div className="mt-6 md:mb-10 lg:mb-20 w-fit h-fit">
                              <Skeleton className="w-[16rem] h-[2rem] lg:h-[2.5rem] border border-graySurface2" />
                         </div>
                    </div>
               </div>
                    ...
                    <div className="flex gap-4 w-full">
                         {Array.from({ length: 3 }).map((_, index) => (
                              <div key={index}
                                   ...
                                   <Skeleton className="h-full w-full rounded-xl border border-graySurface2" />
                              </div>
                         ))}
                    </div>
               </div>
