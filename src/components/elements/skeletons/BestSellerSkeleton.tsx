               ...
               <div className='my-10 flex gap-x-6'>
                    {skeletonItems.map((_, index) => (
                         <div key={index} className='w-full relative h-[22rem]'>
                              <Skeleton className="rounded-3xl w-full h-full border border-graySurface2" />
                              <Skeleton circle className="absolute border border-graySurface2 size-16 top-7 left-7" />
                              <div className="absolute top-7 left-28 flex flex-col gap-y-2">
                                   <Skeleton className="border border-graySurface2 w-48 h-[1.8rem]" />
                                   <Skeleton className="border border-graySurface2 w-28 h-[1.2rem]" />
                              </div>
